...
//         // global coords
//         this.boundary.copyMouseData = (from:FederatedPointerEvent, to:FederatedPointerEvent) =>
//         {
...
// const stars = [1, 2, 3].map((i) => new Graphics().beginFill(0xffffff, 0.75).drawStar(0, 0, 18 / i, (100 * i) / 2));
...
// const coordinates = new BitmapText('Global: (0, 0)\nScreen: (0, 0)', {
